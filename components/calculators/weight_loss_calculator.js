...
import Daily_calorie_need from "./daily_calorie_need";
import { commalise_figures, to_title } from "@/assets/js/utils/functions";

class Weight_loss_calculator extends React.Component {
  constructor(props) {
    super(props);
  ...
  calculate = () => {
    ...
    let daily_calorie_need = new Daily_calorie_need().calculate({
      weight,
      height,
      age,
      sex,
    ...
    this.setState({ daily_calorie_intake, done: true });

    return daily_calorie_intake;
  };

  render() {
    let { weight, height, daily_calorie_intake, goal, age, sex, done } =
      this.state;
      ...
      <div>
        <div className="crs_grid">
          <div className="modal-header">
            <h3 className="modal-title text-dark">Weight Loss Calculator</h3>
          </div>
              ...
              {done ? (
                <div className="crs_grid p-2 py-5 text-center">
                  ...
                  <h2 className="text-center mb-2">
                    {commalise_figures(parseInt(daily_calorie_intake))} calories
                  </h2>
                </div>
              ) : null}
            </div>
...
export default Weight_loss_calculator;
